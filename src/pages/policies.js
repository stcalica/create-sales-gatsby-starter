...
const PolicyPage = () => (
  <>
    <div  style={{paddingBottom: '150px'}} >
        ...
        <p> ---- </p>
        <p>Our return policy is 30 days. If 30 days have gone by since your purchase, unfortunately we cannot offer you a refund or exchange.</p>
    <p>To be eligible for a return, your item must be unused and in the same condition that you received it. It must also be packaged in the original packaging.</p>
    <p>To complete your return, we require a receipt or proof of purchase.</p>
    <p>Please do not send your purchase back to the manufacturer.</p>
    <p>There are certain situations where only partial refunds are granted:</p>
    <ul><li> Any item not in its original condition, that is damaged or missing parts for reasons not due to our error.</li>
    <li>Any item that is returned more than 30 days after delivery.</li></ul>
    <h3><strong>Refunds (if applicable)</strong></h3>
    <p>Once your return is received and inspected, we will send you an email to notify you that we have received your returned item. We will notify you of the approval or rejection of your refund.</p>
    <p>If you are approved, then your refund will be processed, and a credit will automatically be applied to your credit card or original method of payment within a week.</p>
    <p>Late or missing refunds (if applicable)</p>
    <p>If you haven’t received a refund, first check your bank account.</p>
    <p>Then contact your credit card company or bank, it may take about a week before your refund is officially posted. There is often some processing time before a refund is posted.
    </p>
    <p>If you’ve done all of this and you still have not received your refund yet, please contact us at kyle@filthyaf.com.</p>
    <h3><strong>Sale items (if applicable)</strong></h3>
    <p>Only regular priced items may be refunded, sale items cannot be returned or refunded.</p>
    <h3><strong>Exchanges (if applicable)</strong></h3>
    <p>We only replace items if they are defective or damaged. If you need to exchange it for the same item, send us an email at kyle@filthyaf.com and send your item to: 410 Bellevue Ave, APT 108, Oakland, CA, 94610, United States.
    </p>
    ...
    <p>If the item wasn’t marked as a gift when purchased, or the gift giver had the order shipped to themselves to give as a gift, we will send a refund to the buyer.
    </p>
    <h3><strong>Shipping</strong></h3>
    <p>To return your product, you should mail your product to: 410 Bellevue Ave, APT 108, Oakland, CA, 94610, United States.
    </p>
    ...
    <p>If you are shipping an item over $75, we recommend using a trackable shipping service or purchasing shipping insurance. We cannot guarantee that we will receive your returned item.
    </p>

    <h3><strong>Spin And Destroy Privacy Policy</strong></h3>
    <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from www.spinanddestroy.com (the “Site”).</p>
    ...
    <p>You can opt out of targeted advertising by:[[INCLUDE OPT-OUT LINKS FROM WHICHEVER SERVICES BEING USED.COMMON LINKS INCLUDE:</p>
    <ul>
      ...
      <li>Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance’s opt-out portal at: http://optout.aboutads.info/.</li>
    </ul>
